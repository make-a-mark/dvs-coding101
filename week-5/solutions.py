...
if string_look in problem_1_list:
...
# Part 1:
if (problem_2_list[0]).startswith("P"):

or 

first_element = problem_2_list[0]

if first_element.startswith("P"):

# Part 2:
if type(problem_2_list[7]) == int:

# Part 3:
if problem_2_list[2].isdigit():
